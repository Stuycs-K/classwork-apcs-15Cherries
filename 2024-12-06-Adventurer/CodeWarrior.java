...
public class CodeWarrior extends Adventurer{
  ...
  /////chaining doesn't affect the time
  //calling single objects doesn't take up bulk of the time
  ...
  public String attack(Adventurer other){
    ...
    //typically don't want to kill them with one go or do no damage at all
    //change the range of values by altering random and the starting value
